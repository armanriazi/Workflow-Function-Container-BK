...
import org.wfc.resourceAllocators.ExContainerAllocationPolicy;
...
import org.wfc.workflow.WFCEngine;
import org.wfc.workflow.WFCPlanner;
...
public class WFCExample {
    ...
    private static int num_user = org.wfc.core.WFCConstants.WFC_NUMBER_USERS;
...
//                VMStartupDelay, ContainerStartupDelay);
    ...
    private static void configureNetwork(int datacenterId,int brokerId) {
        ...
        org.cloudbus.cloudsim.NetworkTopology.buildNetworkTopology("./topology.brite");        
        int briteNode = 0;                
        org.cloudbus.cloudsim.NetworkTopology.mapNode(datacenterId, briteNode);

        //Broker will correspond to BRITE node 3
        briteNode = 3;
        org.cloudbus.cloudsim.NetworkTopology.mapNode(brokerId, briteNode);
